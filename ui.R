...
dashboardPage(skin="blue",
              ...
              dashboardSidebar(
                ...
                sidebarMenu(id = "tabs",
                  ...
                  menuItem("Filtering", tabName = "first", icon = icon("wpexplorer")),
                  menuItem("Hypothesis Testing", tabName = "second", icon = icon("cogs")),
                  menuItem("Data", tabName = "fourth", icon = icon("table"))
                )),
                          ...
                          fluidRow(
                            ...
                            column(4,
                                   ...
                                   conditionalPanel(condition = 'input.rand',
                                                    ...
                                                    conditionalPanel(condition = 'input.resample', 
                            ...
                            column(8,
                                   ...
                                   # )
                                   conditionalPanel("input.resample",
                                                    uiOutput("text1NBA"),
                                                    uiOutput("text2NBA")
                                   ),
